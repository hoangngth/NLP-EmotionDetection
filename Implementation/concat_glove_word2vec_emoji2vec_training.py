...
#----------------------------------------------------------
# MODEL 3 (Emoji2Vec-LSTM)
# Load word embedding, process WE file
def train_e2v_lstm(we_dir, emb_dim):
    # Load word embedding, process WE file
    embedding_index = dict()
    print('Converting into dictionary of vectorized words...')
    f = open(we_dir, encoding='utf-8', errors='ignore')
...
out3 = model_3(concatenated_input) 
concatenated_output = Concatenate()([out1,out2,out3])
...
final_model.save(os.getcwd()+'/Model/glove-w2v-e2v_model.h5')
print('Model saved to '+os.getcwd()+'/Model/glove-w2v-e2v_model.h5')
